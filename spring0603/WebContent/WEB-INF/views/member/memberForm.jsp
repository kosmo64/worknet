...
<!-- article 영역 시작 -->
 ...
 <%-- Content 내용들어 갈자리 --%>   
   ...
   <table>
   		<tr>
   		   <td>아이디</td>
   		   <td><input type="text" name="id" id="id" maxlength="10" style="width: 130px"> 
   		   	   <input type="button" value="중복확인" id="idChkBtn" style="width: 150px; 
	...
	$('#idChkBtn').click(function(){
		$.ajax({
			...
			success:function(data){
				...
				if(data === 0){
					$('#target').html("<p style='color:blue'>사용 가능</p>");
				}else{
